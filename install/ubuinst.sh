...
exit;
  ...
  echo -e 'by: @sonyc+mod >/usr/lib/telegram
  msg -bar
...
echo -e "                              \033[1;31mBy @sonyc_mod\033[1;36m" | lolcat
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@sonyc_mod\033[0m" | lolcat
echo ""
